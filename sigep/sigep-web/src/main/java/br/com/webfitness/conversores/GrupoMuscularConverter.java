 ...
 *
 */
@FacesConverter("grupoMuscularConverter")
public class GrupoMuscularConverter implements Converter {
	...
	public Object getAsObject(FacesContext context, UIComponent componente, String valor) {
		if(valor != null){
			return new GrupoMuscular(valor);
		}
		return null;
	}
	...
	public String getAsString(FacesContext context, UIComponent componente, Object objeto) {
		if(objeto instanceof GrupoMuscular){
			GrupoMuscular grupo = (GrupoMuscular) objeto;
